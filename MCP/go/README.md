...
This MCP (Model Content Protocol) server provides access to Amazon Sagemaker Edge Manager API functionality through HTTP, HTTPS, and STDIO transport modes.
